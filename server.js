...
const fs = require('fs');
//Paquete npm jsonwebtoken.
const jwt = require('jsonwebtoken');
//El método crypto.randomBytes() se utiliza para generar datos aleatorios artificiales criptográficamente bien construidos 
//y la cantidad de bytes que se generarán en el código escrito.
...
// Endpoint de contenido (test a cookie)
